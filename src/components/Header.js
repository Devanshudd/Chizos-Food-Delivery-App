...
const Header = () => {
  ...
  const normalLink =
    "relative after:bg-red-600 after:h-[0.1em] after:absolute after:-bottom-1 after:left-0 after:hover:w-[100%] after:hover:animate-[hoverWidth_0.5s_linear]";
  ...
  return (
    ...
    <div className="header fixed z-50 top-0 left-0 right-0 flex justify-between bg-white shadow-md h-16 xs:h-24">
      <div className="logo-container flex items-center">
        ...
        <div
          className="flex items-center p-4 xs:text-xl hover:text-red-900 cursor-pointer text-red-700 bg-transparent"
      ...
      <div className="flex items-center">
        <button
          className="lg:hidden text-black focus:outline-none ml-4 mr-14"
        ...
        <ul
          className={`fixed lg:flex lg:static m-8 mr-0 p-4 right-0 top-8 xs:top-16 bg-white transform ${
        ...
        >
          ...
          <li className="px-4 flex mb-4 lg:mb-0">
            {/* <div className="flex">
              ...
              <span>
                <FaSearch className="w-5 h-5 mt-1 ml-1" />
              </span>{" "}
            </div> */}
            <NavLink
              to="/about"
          ...
          <li className="px-4 mb-4 lg:mb-0">
          ...
          <li className="px-4 relative mb-4 lg:mb-0">
            <Link to="/cart">
              <div className="flex">
                <span>Cart</span>{" "}
                <span>
                  <FaShoppingCart className="h-8 w-8 text-red-700" />
                </span>
              </div>
              <span className="absolute top-0 left-14 text-gray-50 font-bold">
                {cartItem.length}
              </span>
            </Link>
          </li>
          {/* <li className="relative w-28">
            <button
              className="login-btn min-w-[4rem] mb-8 lg:mb-0"
              onClick={() => {
                userStatus === "Login"
            ...
            <p className="absolute left-0 top-8">
              {userStatus === "Login" ? "" : "User :" + loggedInUser}
            </p>
          </li> */}
        </ul>
      </div>
      ...
      <div
        className={`transition-transform transform duration-500 ease-in-out ${
          cityVisibility ? "translate-x-0" : "-translate-x-full"
        } bg-slate-100 p-4 absolute top-0 left-0`}
      >
