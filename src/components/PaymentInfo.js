...
const PaymentForm = () => {
  ...
  const handleConfirmOrder = () => {
    ...
    if (!dateRegex.test(expiryDate)) {
      setWarnings({
        ...warnings,
        expiryDate: "Please enter a valid expiry date in MM/YY format.",
      });
      return;
    } else {
    ...
    const enteredDate = new Date(
      `20${expiryDate.slice(3, 5)}`,
      expiryDate.slice(0, 2) - 1,
      1
    );
    ...
    <div className="max-w-md mx-auto p-4 pb-12">
      ...
      <div className="-ml-4 p-4 border border-red-100 rounded-lg mb-6">
        <div className="mb-4">
          ...
          <p className="text-red-700 text-xl sm:font-bold">
            &#8377;{grandTotal}
          </p>
        </div>
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            This is a demo app. Please do not enter your actual card details.
            Use the following test card number for demo purposes: <br />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className={`mt-1 p-2 w-full border rounded-md ${
            warnings.cardNumber ? "border-red-500" : ""
          }`}
          ...
          onChange={(e) => {
            ...
            setWarnings({ ...warnings, cardNumber: "" });
          }}
        />
        {warnings.cardNumber && (
          <p className="text-red-500 text-sm mt-1">{warnings.cardNumber}</p>
        )}
      </div>
      <div className="mb-4">
        <label
        ...
        <input
          ...
          id="expiryDate"
          className={`mt-1 p-2 w-full border rounded-md ${
            warnings.expiryDate ? "border-red-500" : ""
          }`}
          placeholder="MM/YY"
          maxLength={5}
          value={expiryDate}
          onChange={(e) => {
            ...
            setWarnings({ ...warnings, expiryDate: "" });
          }}
        />
        {warnings.expiryDate && (
          <p className="text-red-500 text-sm mt-1">{warnings.expiryDate}</p>
        )}
      </div>
      <div className="mb-4">
        <label
        ...
        <input
          ...
          onChange={(e) => {
            ...
            setWarnings({ ...warnings, cvv: "" });
          }}
        />
        {warnings.cvv && (
          <p className="text-red-500 text-sm mt-1">{warnings.cvv}</p>
        )}
      </div>
      <button
        type="button"
